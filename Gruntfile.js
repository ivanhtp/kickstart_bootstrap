...
module.exports = function (grunt) {
                ...
                files: [
                    {
                        ...
                        dest: 'build/<%= pkg.name %>/<%= pkg.version %>/pending/js/vendors/lib/bootstrap/bootstrap.min.js'
                    },
                // AngularJS
                    {
                        src: [
                        ...
                        dest: 'build/<%= pkg.name %>/<%= pkg.version %>/pending/js/vendors/lib/angularjs/angular.min.js'
                    },
                // App Javascripts
                    {
                        src : [
                        ...
                        dest : 'build/<%= pkg.name %>/<%= pkg.version %>/pending/js/app.min.js'
                    }
                ]
            }
        },
            ...
            dev: {
                ...
                files: [
                    // pending
                    {
                        ...
                        cwd: 'src/',
                        src: '**/*.html',
                        dest: 'build/<%= pkg.name %>/<%= pkg.version %>/pending'
                    }
                ]
            },
            dist: {
    ...
    grunt.registerTask('dev', ['clean', 'uglify', 'compass:dev', 'htmlmin:dev', 'copy', 'connect']);
    grunt.registerTask('dist', ['clean', 'uglify', 'compass:dist', 'htmlmin:dist', 'copy']);
